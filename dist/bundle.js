...
var daysOfTheWeek = ["Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота", "Воскресенье"];
{
...
var createElement = function createElement(elementTagName, className) {
  var newElement = document.createElement(elementTagName);
  newElement.setAttribute('class', className);
  return newElement;
};

var createTaskCell = function createTaskCell(day) {
  var cellBody = createElement('td', 'calendar__cell');
  var cellHeader = createElement('div', 'calendar__cell_header');
  cellHeader.textContent = day;
  var cellTaskBody = createElement('div', 'calendar__cell_task_body');
...
var generateCalendar = function generateCalendar(date) {
  ...
  var daysInMonth = date.setMonth(date.getMonth() + 1);
  daysInMonth.setDate();
